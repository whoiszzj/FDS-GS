...
class GaussianModel:
    ...
    def get_scaling(self):
        return self.scaling_activation(self._scaling) * self.R_activation(self._R)
    ...
    def save_ply(self, path):
        ...
        attributes = np.concatenate((xyz, normals, f_dc, f_rest, opacities, R, scale, rotation), axis=1)
    ...
    def reset_R(self):
        R_new = self.inverse_R_activation(self.compute_radius()[..., None])
