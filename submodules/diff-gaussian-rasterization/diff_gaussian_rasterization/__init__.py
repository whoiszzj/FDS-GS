...
class _RasterizeGaussians(torch.autograd.Function):
    ...
    def forward(
        ...
        args = (
            ...
            raster_settings.contrib_weight,
        ...
        ctx.save_for_backward(colors_precomp, means3D, scales,
                              rotations, cov3Ds_precomp, radii, sh,
                              geomBuffer, binningBuffer, imgBuffer)
        return color, radii, contrib_weight
    ...
    def backward(
        ...
        # print(grad_out_color.shape, grad_out_radii.shape, grad_out_depth.shape)
